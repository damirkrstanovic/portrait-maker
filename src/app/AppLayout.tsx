...
export function AppLayout({ library, busy, onImport, onExport, onDestinations, destinationsTriggerRef, onBackup, onFindDuplicates, onCloseLibrary, children }: Props) {
